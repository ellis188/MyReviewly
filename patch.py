...
for bp in body_patterns:
    if bp in js:
        ...
        print(f"OK: hamburger with How it works injected before {bp}")
        inserted = True
        break
...
with open("worker.js", "w", encoding="utf-8") as f:
    f.write(js)
print(f"Saved: {len(js)} bytes, injected: {inserted}")
